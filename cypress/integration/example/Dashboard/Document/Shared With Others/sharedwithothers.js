...
{
    it('View Shared With Others Folder', function()
    ...
    {     
        ...
        //click on shared with others folder
        cy.get('[aria-describedby="cdk-describedby-message-19"] > .folder-inner > .folder-name-container').click()
